...
#   Node Env
#   ---------------------------------------
    export NVM_DIR="/Users/m.kluj/.nvm"
...
#   OSX
    nvim () {
      sudo docker run -it -v "$dir_name":/data:cached sankluj/neovim:latest
    }
#   LINUX
#     nvim () {
#       sudo docker run -it -v "$dir_name":/data sankluj/neovim:latest
#     }
